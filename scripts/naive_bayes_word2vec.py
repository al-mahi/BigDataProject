...
if __name__ == '__main__':
    ...
    ngramDataFrame.select("label", "ngrams").show(truncate=False)

    ngramData = ngramDataFrame.select("label", "ngrams")

    word2Vec = Word2Vec(vectorSize=1000, minCount=0, inputCol="ngrams", outputCol="feature")
    model = word2Vec.fit(ngramData)
